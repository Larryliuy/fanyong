		...
		props: {
			...
			contentText: {
				...
				default () {
					return {
						contentdown: '',
						contentrefresh: this.$t('xf_loading'),
						contentnomore: this.$t('xf_nd')
					}
				}
			}
		},
