		...
		<view class="detail-box">
			...
			<view class="list-box">
				<view class="list-item flex" style="justify-content: space-between;">
					<text>{{$t('v_djjw')}}</text>
					<text style="color: #EAA942;text-align: right;">{{dataList.goods_price}}<text v-if="environment === 'sw_pro'" style="margin-left: 2px;color: #EAA942;">USDT</text></text>
				</view>
				...
				<view class="list-item flex">
					<text>{{$t('xf_522')}}</text>
					<text style="color: #EAA942;text-align: right;">{{dataList.goods_count}}<text v-if="environment === 'sw_pro'" style="margin-left: 2px;color: #EAA942;">USDT</text></text>
				</view>
				<view class="list-item flex" style="justify-content: space-between;">
					<text>{{$t('v_zsjnor')}}</text>
					<text style="color: #EAA942;text-align: right;">{{dataList.num}}<text v-if="environment === 'sw_pro'" style="margin-left: 2px;color: #EAA942;">USDT</text></text>
				</view>
				<view class="list-item flex">
					<text>{{$t('v_ubyi')}}</text>
